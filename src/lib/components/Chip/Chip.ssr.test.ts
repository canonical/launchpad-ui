...
describe("Chip SSR", () => {
  describe("Initial Rendering", () => {
    test("should render without errors when given required props", () => {
      expect(() =>
    ...
    test("should render with lead text", () => {
      const { body } = render(Component, {
  ...
  describe("State Variants", () => {
    ...
    test("should render a dismiss button when ondismiss is provided", () => {
      const { body } = render(Component, {
    ...
    test("should be non-interactive when readonly", () => {
      const { body } = render(Component, {
  ...
  describe("Accessibility", () => {
    test("should include aria-label on dismiss button", () => {
      const { body } = render(Component, {
        props: { value: "Dismissible", ondismiss: () => {} },
      });
