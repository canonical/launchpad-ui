...
describe("NoResults SSR", () => {
  ...
  describe("Renders", () => {
    it("default content", () => {
      ...
      expect(page.container.innerHTML).toContain("No results.");
    });
    ...
    it("with children", () => {
      ...
      expect(page.container.innerHTML).toContain("Nothing found");
    });
  });
  ...
  describe("attributes", () => {
    ...
    it("applies classes", () => {
      ...
      expect(componentLocator(page)?.classList).toContain("no-results");
    });
